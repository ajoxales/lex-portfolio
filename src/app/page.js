      ...
      <div>
        <div id="hero" className="pt-5">
          <Container>
            <div className="d-flex justify-content-between pb-5 pt-3">
              <div>
                <div id="title" className="mx-2 text-center text-sm-start">
                  <motion.div
          ...
          >
            <article className="ms-2 py-5">
              ...
              <p>
                ...
                incredibly motivating. I love brainstorming innovative solutions
        ...
        <Container className="py-5">
          <div className="text-white pt-5 pb-1 mb-3">
            ...
            <p>I've been working on projects using these technologies.</p>
          </div>
          <Skills />
        </Container>
