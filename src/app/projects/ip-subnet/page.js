...
import style from "@/app/projects/ip-subnet/styles/styles.module.css";
  ...
  return (
    <div>
      <div className="container d-flex flex-column justify-content-center align-items-center m-auto text-white">
        <h1 className="container text-center my-3 ">IPv4 Subnet Calculator</h1>
        <p className="w-75 text-center mb-4">
          This IP Subnet Calculator takes an IP address and netmask and
          calculates the resulting broadcast and network addresses, usable
          hosts, subnet mask, IP class, and other essential details. With the
          ability to handle CIDR notation and dotted decimals, this calculator
          simplifies the process of designing subnets ensuring efficient network
        ...
        <Form
          ...
          <Form.Group
            className={`${style.ipText} mx-2 col-8 col-sm-6 my-2 mt-sm-2`}>
            <InputGroup>
          ...
          <Form.Group
            className={`${style.cidrText} col-8 col-sm-2 my-2 mt-sm-2`}>
            <InputGroup>
          ...
          <Button
            type="submit"
            variant="light"
            className={`${style.calcBtn} mx-2 col-12 col-sm-2 my-2`}>
            Calculate
          </Button>
        </Form>
      </div>
      ...
      <div className="container table-responsive ">
        <div className="bg-dark px-1 rounded-2">
          <Table variant="dark" className="container mt-3 mb-5 table">
            ...
            <tbody>
              <tr className={`${style.row} text-center`}>
        ...
        <Table variant="dark" className="container">
          <tbody className={style.table}>
            <tr>
              ...
              <td className="table-dark text-break  ">{subnetMask}</td>
            </tr>
            <tr>
              <td className="w-50 text-break">Binary Subnet Mask:</td>
              <td className="table-dark text-break  ">{subnetMaskOctet}</td>
            </tr>
            <tr>
              <td className="w-50">IP Class:</td>
              <td className="table-dark text-break  ">{ipClass}</td>
            </tr>
            <tr>
              <td className="w-50">Total Number of Hosts:</td>
              <td className="table-dark text-break  ">{totalHosts}</td>
            </tr>
            <tr>
              <td className="w-50">Usable Hosts:</td>
              <td className="table-dark text-break  ">{usableHosts}</td>
            </tr>
          </tbody>
        </Table>
      </div>
